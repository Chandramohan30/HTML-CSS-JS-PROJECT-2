...
c.innerHTML+="<button onclick='redirect()' id='ho'>"+
'Home'+"</button></a>";
}
}
else{
...
c.innerHTML+="<span style='font-style:italic;'>"+"Welcome to the website ofLibrary Management System We are thrilled to introduce you to a groundbreakingsolution that revolutionizes the way libraries function, creating a seamless experience for both patrons and administrators."+ "</span>"+"<br>";
c.innerHTML+="<button id='st' class='btn' style='margin-top:10px;marginleft:300px' onclick='gocontent()'>"+ 'START'+"</button>";
}
function gocontent(){
document.getElementById("box1").style.display='grid';
document.getElementById("box2").style.display='none';
